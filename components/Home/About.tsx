      ...
      <HStack className="flex flex-col items-center justify-center gap-5 lg:flex-row lg:items-start lg:gap-16">
        <div className="grid max-w-xl flex-1">
          ...
          <p className="home-about-body">
              ...
              <span className="bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text font-extrabold text-transparent dark:from-primary-500 dark:to-secondary-500">Next.js & Node.js!</span>. I have gained
