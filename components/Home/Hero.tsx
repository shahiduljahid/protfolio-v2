      ...
      <Container>
        ...
        <div className="grid grid-cols-12 gap-2">
          <div className="col-span-12  flex  max-w-3xl flex-col sm:col-span-12 md:col-span-12 lg:col-span-12 xl:col-span-6">
            ...
            <h1 className="mb-3 h-[55px] bg-gradient-to-r from-primary-600 to-secondary-600 bg-clip-text text-4xl font-extrabold text-transparent dark:from-primary-500 dark:to-secondary-500 md:text-5xl">
              <Type />
            </h1>
