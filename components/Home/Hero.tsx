  ...
  return (
    <section style={{paddingTop:'50px'}} ref={refs.home} >
      ...
      <div className="flex w-full max-w-3xl  flex-col">
          ...
          <h2 className="mb-2 text-3xl font-bold text-gray-600 dark:text-gray-400 md:text-4xl">I build things for the web.</h2>
          <div className="heading-description" style={{ textAlign: "left" }}>
            ...
            . My unwavering commitment to excellence is evident in my focus on advancing my software
            engineering skills to keep pace with industry advancements and standards.
          </div>
        ...
        <img width="400px" src={'/hero.gif'}></img>
